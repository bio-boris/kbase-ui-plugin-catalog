define([
    ...
    function widget(config) {
        ...
        function render() {
            ...
            return div({
                id: widgetSet.addWidget('catalog_queue_status_widget',
                    {
                        jqueryName: 'KBaseCatalogQueueStatus',
                        jquery_name:'KBaseCatalogQueueStatus'
                    })
            });
        }
        ...
        function attach(node) {
            runtime.send('ui', 'setTitle', 'Queue Status');
            return Promise.try(function () {
                mount = node;
